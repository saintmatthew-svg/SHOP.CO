  ...
  return (
    <footer className="bg-gray-100 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-black rounded-2xl p-8 mb-16 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-full text-black placeholder-gray-500 outline-none"
                />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 bg-white rounded-full flex items-center justify-center border hover:bg-gray-50">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link to="/support" className="hover:text-black">Customer Support</Link></li>
              <li><Link to="/delivery" className="hover:text-black">Delivery Details</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link to="/ebooks" className="hover:text-black">Free eBooks</Link></li>
              <li><Link to="/tutorial" className="hover:text-black">Development Tutorial</Link></li>
              <li><Link to="/blog" className="hover:text-black">How to - Blog</Link></li>
              <li><Link to="/youtube" className="hover:text-black">Youtube Playlist</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-300 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <img src="Badge.png" alt="Visa" className="h-10" />
            <img src="Badges.png" alt="Mastercard" className="h-10" />
            <img src="Badge (1).png" alt="PayPal" className="h-10" />
            <img src="Badge (3).png" alt="Apple Pay" className="h-10" />
          </div>
        </div>
      </div>
    </footer>
